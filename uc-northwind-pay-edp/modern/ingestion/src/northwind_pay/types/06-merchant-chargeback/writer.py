"""Deterministic Type 06 Parquet schema. Column order matches the sanitized CSV contract."""
...
SCHEMA_FIELDS: tuple[tuple[str, pa.DataType], ...] = (
    ...
    ("original_amount_brl", pa.decimal128(18, 2)),
    ("rate_percent", pa.decimal128(9, 3)),
    ("chargeback_amount_brl", pa.decimal128(18, 2)),
    ("calculated_amount_brl", pa.decimal128(18, 2)),
    ("business_date", pa.string()),
...
def table(
    ...
    *,
    ...
    columns = {
        ...
        "chargeback_id": [record.chargeback_id for record in ordered],
        ...
        "reason_code": [record.reason_code for record in ordered],
        "description": [record.description for record in ordered],
        "original_amount_brl": [record.original_amount_brl for record in ordered],
        "rate_percent": [record.rate_percent for record in ordered],
        "chargeback_amount_brl": [record.chargeback_amount_brl for record in ordered],
        "calculated_amount_brl": [record.calculated_amount_brl for record in ordered],
        "business_date": [record.business_date for record in ordered],
