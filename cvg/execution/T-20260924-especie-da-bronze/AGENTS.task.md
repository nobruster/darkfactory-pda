# Task brief — T-20260924-especie-da-bronze
...
- **Spec (canonical):** `cvg/tasks/T-20260924-especie-da-bronze.md`
- **Contract:** `cvg/execution/T-20260924-especie-da-bronze/execution-profile.yaml`
- **Epoch:** `T-20260924-especie-da-bronze@e9d647faa9cc`
...
```bash
python3 skills/task-to-runtime-contract/scripts/check-path-policy.py --profile cvg/execution/T-20260924-especie-da-bronze/execution-profile.yaml --base "$CVG_BASE_REF"
```
