# Task brief — T-20260924-gramatica-do-juiz
...
- **Spec (canonical):** `cvg/tasks/T-20260924-gramatica-do-juiz.md`
- **Contract:** `cvg/execution/T-20260924-gramatica-do-juiz/execution-profile.yaml`
- **Epoch:** `T-20260924-gramatica-do-juiz@736069de71b7`
...
```bash
python3 skills/task-to-runtime-contract/scripts/check-path-policy.py --profile cvg/execution/T-20260924-gramatica-do-juiz/execution-profile.yaml --base "$CVG_BASE_REF"
```
