# Task brief — T-20260924-gold-referencia
...
- **Spec (canonical):** `cvg/tasks/T-20260924-gold-referencia.md`
- **Contract:** `cvg/execution/T-20260924-gold-referencia/execution-profile.yaml`
- **Epoch:** `T-20260924-gold-referencia@6d0ce6a24f47`
...
```bash
python3 skills/task-to-runtime-contract/scripts/check-path-policy.py --profile cvg/execution/T-20260924-gold-referencia/execution-profile.yaml --base "$CVG_BASE_REF"
```
