# Task brief — T-20260924-ontologia-versionada
...
```bash
python3 skills/task-to-runtime-contract/scripts/check-path-policy.py --profile cvg/execution/T-20260924-ontologia-versionada/execution-profile.yaml --base "$CVG_BASE_REF"
```
