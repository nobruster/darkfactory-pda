# Task brief — T-20260925-gold-nome-oficial
...
- **Spec (canonical):** `cvg/tasks/T-20260925-gold-nome-oficial.md`
- **Contract:** `cvg/execution/T-20260925-gold-nome-oficial/execution-profile.yaml`
- **Epoch:** `T-20260925-gold-nome-oficial@38c2dbd75345`
...
```bash
python3 skills/task-to-runtime-contract/scripts/check-path-policy.py --profile cvg/execution/T-20260925-gold-nome-oficial/execution-profile.yaml --base "$CVG_BASE_REF"
```
