  ...
  - id: LEG-AGREGADO-EXATO
    ...
    - id: T-20260917-agregacao-exata
      ...
      - id: B-2
        ...
        then: precisão E modo são DECLARADOS, não herdados — com prec=6 a soma acusa a perda (10000.00
          + 0.01 vira 10000.0, e quantizar depois não recupera, ADR 0006); trocar o default do contexto
          para meio-para-cima faz o teste falhar se a implementação o herdar; e arredondar por campo dá
          4,68 contra 4,69 no total (ADR 0004)
      evals:
      - id: eval_1
