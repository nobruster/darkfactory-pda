    ...
    - id: T-20260921-orquestra-desfecho
      ...
      - id: B-2
        ...
        then: a exceção vira ERRO com pacote gravado, e o tempo do início da leitura ao veredito é medido
          e REGISTRADO no pacote, sem virar recusa — R-9 é should, e o pacote passa a carregar o número
          para que a cobertura de R-9 seja decidida contra competência real, não contra relógio simulado.
          Se o PRÓPRIO gravador falhar — permissão negada, disco cheio — o desfecho é ERRO com código
