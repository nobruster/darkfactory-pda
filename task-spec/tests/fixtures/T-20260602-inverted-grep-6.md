---
id: T-20260602-inverted-grep-6
title: Substitution-with-true-fallback followed by numeric compare
status: ready
format_version: 2
effort: S
...
# Substitution-with-true-fallback followed by numeric compare

> **Why:** Pattern 6: $(cmd) || true followed by integer compare without ${var:-0} normalisation
