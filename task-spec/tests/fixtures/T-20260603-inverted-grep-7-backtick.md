---
id: T-20260603-inverted-grep-7-backtick
title: Inverted grep -c with backtick substitution + echo 0 fallback
status: ready
format_version: 2
effort: S
...
# Inverted grep -c with backtick substitution + echo 0 fallback

> **Why:** Backtick form of Variant 1 — the per-command regex only matches $(...) and would miss `...`; the umbrella rule must catch it
