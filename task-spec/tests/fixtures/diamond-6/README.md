# tests/fixtures/diamond-6 — the 6-task diamond backlog
...
```bash
taskspec validate tests/fixtures/diamond-6/T-20260716-build-daily-totals.md
taskspec gate tests/fixtures/diamond-6/T-20260716-add-quality-check.md   # read-only, NO --stamp
```

See P0-1 in `docs/roadmap.md`: these six are the backlog the multi-engine CI proof
runs green.
