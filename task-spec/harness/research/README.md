...
```bash
harness/research/firecrawl/fake-adapter.sh "atomic task research"
harness/research/tavily/fake-adapter.sh "atomic task research"
harness/research/exa/fake-adapter.sh "atomic task research"
