...
|---|---|---|
| Six-tier sizing, L routing, XL/XXL composition | `skills/task-spec/scripts/_lib.sh`, `validate-task-spec.sh`, `src/templates/task-spec.md.tpl`, `references/concepts/effort-gate.md`, `tests/test-effort-sizing.sh` | `src/lib/_lib.sh`, `src/gate/validate-task-spec.sh`, template, schema, guide, and sizing suite |
...
| Installation and skill surface | `scripts/install.sh`, `SKILL.md`, `harness/agents/task-architect.md`, runbooks | Multi-harness non-clobbering installer, canonical root skill, compatibility task architect, and new docs front |
