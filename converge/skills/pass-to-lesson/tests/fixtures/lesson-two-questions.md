# Lesson — Pass 2 (Structure): CI pipeline grounding (two-questions fixture)

> Negative fixture: only 2 check-yourself questions (3–5 required). Everything
> else is valid, so the gate must FAIL on the question count.
