# Lesson — Pass 2 (Structure): CI pipeline grounding (plain fixture)

> Back-compat fixture: no `modes:` line — every mode check must skip, and the
> base gate must still pass in full.
