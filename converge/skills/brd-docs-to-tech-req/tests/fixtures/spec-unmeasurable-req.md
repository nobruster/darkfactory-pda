# Tech-Spec — Fixture: one unmeasurable requirement must warn by id
...
- **R-3 (should).** The lane feels smooth and pleasant for the on-call
  team to operate during an incident.
