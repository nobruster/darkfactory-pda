# Tech-Spec — Fixture: CI pipeline recovery lane (infra leak must warn)
...
- The CI system's webhook stream is reliable enough to build on.
  owner: Platform Lead
- The client asked whether Kubernetes will host the lane and whether
  Terraform will provision it — a Pass 3 question, deliberately not
  answered here. owner: Platform Lead
