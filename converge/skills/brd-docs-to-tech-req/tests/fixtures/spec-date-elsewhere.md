# Tech-Spec — Fixture: a date far from the verdict does not bind (signed 2026-07-19)

> Interrogation completed 2026-07-19; all decisions locked the same day.
...
- **Scope of sign-off:** the full spec, no exceptions noted
