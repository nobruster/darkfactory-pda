# Tech-Spec — Fixture: substantively resolved blocker passes
...
- id: GAP-001
  ...
  owner: "Platform Lead"
  resolution: "Owner call 2026-07-20 — ceiling of 20 retries per day stands; revisited only if the on-call load breaches 1 hour/week"
```
