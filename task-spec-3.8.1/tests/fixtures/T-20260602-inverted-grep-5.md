---
id: T-20260602-inverted-grep-5
title: Multi-line non-integer substitution (runtime check)
status: ready
format_version: 2
effort: S
...
# Multi-line non-integer substitution (runtime check)

> **Why:** Pattern 5: multi-line substitution produces non-integer; --dry-run-eval catches it
