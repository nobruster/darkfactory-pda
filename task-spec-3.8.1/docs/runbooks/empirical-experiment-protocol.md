...
- [edd-vs-sdd-honest-comparison.md](../concepts/edd-vs-sdd-honest-comparison.md) — theoretical comparison
- [eval-driven-development.md](../concepts/eval-driven-development.md) — the methodology itself
