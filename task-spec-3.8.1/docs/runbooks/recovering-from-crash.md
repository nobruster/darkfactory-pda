...
```bash
# Resume
taskspec transition T-XXX ready "recovered after crash"

# Or park
taskspec transition T-XXX parked "crashed at iteration N"

# Or finalize
taskspec transition T-XXX done "completed before crash"
```
