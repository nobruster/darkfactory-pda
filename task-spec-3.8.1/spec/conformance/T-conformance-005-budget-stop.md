...
depends_on: []
touches_paths:
  - spec/conformance/_workdir/c005_iterations.log
...
```bash
eval_1() {
  test -f spec/conformance/_workdir/c005_iterations.log
}

eval_2() {
  test "$(wc -l < spec/conformance/_workdir/c005_iterations.log)" -le 2
}

eval_3() {
  test "$(wc -l < spec/conformance/_workdir/c005_iterations.log)" -ge 1
}
...
agent_contract:
  ...
  sandbox_type: host
  output_artifacts:
    - path: spec/conformance/_workdir/c005_iterations.log
      type: log
  mcp_dependencies: []
  emit:
    - parked_with_context
...
Delete `spec/conformance/_workdir/c005_iterations.log` and re-run.
