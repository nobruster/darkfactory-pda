...
kind: seam
claim: derived
id: SEAM-SILVER-E-INGESTAO-EVOLUEM
name: Silver e ingestão evoluem por padrão
description: 'Boas práticas Delta: Silver e ingestão evoluem por padrão.'
evidence:
- E-ADR-0017
responsibility: Silver e ingestão evoluem por padrão
consumes:
- sessao declarada
produces: &id001
- silver evolui
owner: medalhao
independent_proof: Coluna nova entra; tipo trocado recusa.
decision_ids:
...
swimlane:
  id: LANE-SILVER-E-INGESTAO-EVOLUEM
  name: Silver e ingestão evoluem por padrão lane
  owner: medalhao
  legs:
  - id: LEG-SILVER-E-INGESTAO-EVOLUEM
    ...
    - id: T-20260925-silver-e-ingestao-evoluem-por-padrao
      ...
      goal: Fazer a Silver e a ingestão evoluírem de forma aditiva por padrão, com a guarda. Para rodar
      ...
      done_condition: executar_classificacao e executar_ingestao têm evolucao_aditiva=True por padrão;
        os testes de tests/test_delta_padroes_silver.py passam.
      effort: M
      profile: standard
      ...
      - id: B-1
        ...
        then: 'as duas passam a ter evolucao_aditiva=True por padrão: coluna nova entra; troca de tipo
          e coluna removida continuam recusadas pela guarda verificar_evolucao; evolucao_aditiva=False
          explícito recusa coluna nova; a ingestão repassa o valor recebido à Bronze.'
      - id: B-2
        given: os testes selados de test_silver.py, test_ingestao.py e test_orquestracao.py
        when: a tarefa termina
        then: nenhum teste existente muda e todos passam; em tests/test_delta_padroes_silver.py entram
          test_silver_evolui_por_padrao, test_silver_troca_de_tipo_recusada, test_silver_coluna_removida_recusada,
          test_silver_evolucao_desligada_recusa, test_ingestao_evolui_por_padrao e test_ingestao_repassa_o_sinalizador.
...
Boas práticas Delta: Silver e ingestão evoluem por padrão.
